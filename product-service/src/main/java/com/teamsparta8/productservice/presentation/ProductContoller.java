...
public class ProductContoller {
	...
	public CommonResponse<ProductResponseDto> createProduct(
		@RequestHeader("X-Request-ID") UUID userId,
		@RequestBody ProductCreateDto requestDto
	) {
		ProductResponseInternalDto response = productService.createProduct(userId, ProductDtoMapper.convertToCreateInternalDto(requestDto));
	...
	public CommonResponse<ProductResponseDto> updateProduct(
		...
		ProductResponseInternalDto response = productService.updateProduct(productId, ProductDtoMapper.convertToUpdateInternalDto(requestDto));
		ProductResponseDto productResponseDto = ProductDtoMapper.convertToResponseDto(response);
	...
	public CommonResponse<ProductResponseDto> getProductDetails(
		@PathVariable("productId") UUID productId
	) {
